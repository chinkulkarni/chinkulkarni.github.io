...
\begin{tabular}{@{}p{5.5in}p{4in}}
{\bf Google} \dotfill Salt Lake City, USA \\
{\small\em Student Researcher hosted by Larry Kai, August 2020 - Present}\\
{\small Research with Slicer, an
application agnostic auto-sharder for stateful services.}
\end{tabular}
...
{\small\em SOSP 2017, Shangai, China}\\
\end{tabular}
